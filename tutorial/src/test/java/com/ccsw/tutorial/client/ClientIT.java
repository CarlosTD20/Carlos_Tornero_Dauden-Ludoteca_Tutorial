...
public class ClientIT {
    ...
    public static final String NEW_CLIENT_NAME  = "user 20";
    public static final Long NEW_CLIENT_ID = 5L;
    public static final Long MODIFY_CLIENT_ID = 4L;
    public static final Long DELTE_CLIENT_ID = 2L;
    ...
    ParameterizedTypeReference<List<ClientDto>> responetype = new ParameterizedTypeReference<List<ClientDto>>() {
    };

    @Test
    public void findAllShouldReturnAllClients() {
        ResponseEntity<List<ClientDto>> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.GET, null, responetype);
    ...
    @Test
    public void modifyWithExistIdShouldMofidyClient() {
        ClientDto dto = new ClientDto();
        dto.setName(NEW_CLIENT_NAME);
